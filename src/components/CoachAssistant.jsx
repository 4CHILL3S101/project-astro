...
export default function CoachComponent() {
  ...
  useEffect(() => {
      const fullMessage = "Welcome Buddy, This is Astro! Your all around coach. Just specify what type of problem you have and I will help you."; 
      let index = 0;
  ...
  const handleSendMessage = async () => {
    ...
    try {
        const response = await ApiRequests.getApiResponse(prompt, "coach");
        setMessages((prev) => [
            ...prev,
